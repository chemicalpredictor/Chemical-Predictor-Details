...
*/
	...
	// ================================
    // Adapter for external visualizer
    // ================================
    window.parse_equation = function(equationString) {
      return chem_parser(equationString);
    };
	window.parseEquationForVisualizer = function(str) {
      return Parser(str);
    };
